<%@ Page Title="" Language="C#" MasterPageFile="~/framework/MasterPage.master" AutoEventWireup="true"
    CodeFile="VcubeMeaDimNew.aspx.cs" Inherits="PlugIn_CustomAnalysis_Pages_VcubeMeaDimNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="2" width="100%">
        <tr>
            <td style="width: 80px; text-align: right;">Cube名称：
            </td>
            <td>
            ...
            <td>
                <table border="0">
                    <tr>
                        ...
                        <td>&nbsp;事实名称：</td>
                        <td>
                            <asp:DropDownList ID="ddlFact" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlFactTable_SelectIndexChanged">
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="2">
                <table cellpadding="2" border="0">
                    <tr><td>待选指标和维度：</td><td></td><td>已选指标和维度：</td></tr>
                    <tr>
                        <td>
                            <div style="height: 430px; overflow: auto; border: 1px solid #dddddd;">
                                ...
                                <div>
                                    ...
                                    <asp:CheckBox runat="server" AutoPostBack="true" ID="chkAllDimension" Text="全选维度"
                                        OnCheckedChanged="chkAllDimension_CheckedChanged" />
                                </div>
                                <asp:TreeView ID="tvCubeOriginal" runat="server" ShowCheckBoxes="Leaf" Width="360px">
                                </asp:TreeView>
                            </div>
                        </td>
                        <td width="90px" align="center">
                            <table width="100%">
                                <tr>
                                    <td align="center">
                                        <asp:Button ID="btnAdd" runat="server" CssClass="button" Text="添加>>"
                        ...
                        <td style="width: 360px;">
                            <table border="0" cellpadding="2" width="100%">
                                <tr>
                                    <td colspan="2">
                                        <div style="height: 430px; overflow: auto; border: 1px solid #dddddd;">
                                            <asp:TreeView ID="tvCubeNewly" runat="server" ShowCheckBoxes="Leaf" Width="360px">
                                            </asp:TreeView>
                                        </div>
                                    </td>
                                </tr>
